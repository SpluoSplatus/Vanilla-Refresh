...
data modify storage vanilla_refresh_config:config config.config.ghost_toggle set value 0
...
execute if score stats_healthFIX:1 run scoreboard objectives setdisplay belowName refresh_player_health
