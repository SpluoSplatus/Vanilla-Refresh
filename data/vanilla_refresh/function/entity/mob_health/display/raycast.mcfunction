...
execute if block ~ ~ ~ #vanilla_refresh:permeable positioned ~ ~-1 ~ unless score temp refresh_storage matches 6.. positioned ^ ^ ^1 positioned ~ ~1 ~ run function vanilla_refresh:entity/mob_health/display/raycast
