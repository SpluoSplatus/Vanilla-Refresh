...
execute if score mob_health refresh_settings matches 1 as @n[type=wolf,distance=..6,scores={refresh_maxhealth=8,refresh_health=20}] run scoreboard players set @s refresh_maxhealth 20
