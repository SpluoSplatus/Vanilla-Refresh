...
execute if score clock refresh_settings matches 2 run tellraw @s [{"translate": "","color": "gray"},{"translate": "ⓘ ","hoverEvent":{"action":"show_text","contents":[{"translate":"When holding a clock, the day and time will show. Place the clock on an item frame and it'll show the time to nearby players."}]}},{"translate":"Readable Clocks: ","color":"gray"},{"translate":"Enabled; Type: Tick","color":"yellow","underlined":true,"hoverEvent":{"action":"show_text","contents":[{"translate":"Type: Tick","color":"yellow"},{"translate":" - Based off the exact daytime tick\nClick to change this setting","color": "white"}]},"clickEvent":{"action":"run_command","value":"/function vanilla_refresh:other/actions/block/clock_disable"}}]
execute if score clock refresh_settings matches 1 run tellraw @s [{"translate": "","color": "gray"},{"translate": "ⓘ ","hoverEvent":{"action":"show_text","contents":[{"translate":"When holding a clock, the day and time will show. Place the clock on an item frame and it'll show the time to nearby players."}]}},{"translate":"Readable Clocks: ","color":"gray"},{"translate":"Enabled; Type: Realistic","color":"yellow","underlined":true,"hoverEvent":{"action":"show_text","contents":[{"translate":"Type: Realistic","color":"yellow"},{"translate":" - Based off the real world clock type\nClick to change this setting","color": "white"}]},"clickEvent":{"action":"run_command","value":"/function vanilla_refresh:other/actions/block/clock_2"}}]
...
tellraw @s [{"translate": "","color": "yellow"},{"translate":"<-- Page 3","color":"yellow","underlined":false,"hoverEvent":{"action":"show_text","contents":[{"translate":"Previous Page"}]},"clickEvent":{"action":"run_command","value":"/function vanilla_refresh:other/menus/block/settings3"}},{"translate":"    - 4/6 -     ","color": "gray","italic": false},{"translate":"","color": "yellow"},{"translate":"Page 5 -->","color":"yellow","underlined":false,"hoverEvent":{"action":"show_text","contents":[{"translate":"Next Page"}]},"clickEvent":{"action":"run_command","value":"/function vanilla_refresh:other/menus/block/settings5"}}]
