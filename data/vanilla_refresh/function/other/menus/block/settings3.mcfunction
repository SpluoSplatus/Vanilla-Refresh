...
execute if score lodestone_teleport_damage refresh_settings matches 0 if score lodestone refresh_settings matches 1 run tellraw @s [{"translate": "","color": "gray"},{"translate": "ⓘ ","hoverEvent":{"action":"show_text","contents":[{"translate":"Makes lodestones a bit more useful.\nDrop a named paper ontop of a lodestone to name it\nChange the color of the text with dyes as well.\nDropping an enderpearl ontop of the lodestones will create an instant waypoint, which can be teleported to instantly via ender pearls."}]}},{"translate":"Better Lodestones: ","color":"gray"},{"translate":"Enabled","color":"green","underlined":true,"hoverEvent":{"action":"show_text","contents":[{"translate":"Click to change this setting"}]},"clickEvent":{"action":"run_command","value":"/function vanilla_refresh:other/actions/block/lodestone_disable"}},{"text": " "},{"translate":"Teleport Damage ❌","color":"dark_gray","underlined":true,"hoverEvent":{"action":"show_text","contents":[{"translate":"The damage players take when throwing an ender pearl to teleport to a lodestone.\nClick to change this setting"}]},"clickEvent":{"action":"run_command","value":"/function vanilla_refresh:other/actions/block/lodestone_damage_1"}}]
execute if score lodestone_teleport_damage refresh_settings matches 1 if score lodestone refresh_settings matches 1 run tellraw @s [{"translate": "","color": "gray"},{"translate": "ⓘ ","hoverEvent":{"action":"show_text","contents":[{"translate":"Makes lodestones a bit more useful.\nDrop a named paper ontop of a lodestone to name it\nChange the color of the text with dyes as well.\nDropping an enderpearl ontop of the lodestones will create an instant waypoint, which can be teleported to instantly via ender pearls."}]}},{"translate":"Better Lodestones: ","color":"gray"},{"translate":"Enabled","color":"green","underlined":true,"hoverEvent":{"action":"show_text","contents":[{"translate":"Click to change this setting"}]},"clickEvent":{"action":"run_command","value":"/function vanilla_refresh:other/actions/block/lodestone_disable"}},{"text": " "},{"translate":"Teleport Damage ✔","color":"yellow","underlined":true,"hoverEvent":{"action":"show_text","contents":[{"translate":"The damage players take when throwing an ender pearl to teleport to a lodestone.\nClick to change this setting"}]},"clickEvent":{"action":"run_command","value":"/function vanilla_refresh:other/actions/block/lodestone_damage_0"}}]
