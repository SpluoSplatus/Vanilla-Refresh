...
execute if score 2tick refresh_clock matches 1 if data block 182 69 -140 ticks_since_song_started run function vanilla_refresh:block/jukebox_stop_sound/stopsound
