...
execute unless score blockanims_beacon refresh_settings matches -1..0 as @e[type=marker,tag=refresh_entity_blockanim_beacon] at @s if entity @p[distance=..96] if block ~ ~ ~ beacon{Levels:4} run function vanilla_refresh:block/block_anims/beacon/thingies
