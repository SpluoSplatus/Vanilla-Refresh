...
execute if score difficulty refresh_gamerules matches 0 run tellraw @s [{"translate": "   ","color": "gray","hoverEvent": {"action": "show_text","value":{"translate":"Click to Open"}},"clickEvent": {"action": "open_url","value": "https://minecraft.wiki/w/Difficulty"}},{"translate":"World Difficulty: "},{"bold":true,"translate":"options.difficulty.peaceful","color": "#a3c0e3"},{"text": "      "},{"text":"+ ","color": "#428cc9","bold": true},{"translate":"Show Edited Gamerules","color": "#428cc9","underlined": true,"hoverEvent":{"action":"show_text","contents":[{"translate":"Click to open"}]},"clickEvent":{"action":"run_command","value":"/trigger gamerules set 90011"}}]
execute if score difficulty refresh_gamerules matches 1 run tellraw @s [{"translate": "   ","color": "gray","hoverEvent": {"action": "show_text","value":{"translate":"Click to Open"}},"clickEvent": {"action": "open_url","value": "https://minecraft.wiki/w/Difficulty"}},{"translate":"World Difficulty: "},{"bold":true,"translate":"options.difficulty.easy","color": "#00ff00"},{"text": "      "},{"text":"+ ","color": "#428cc9","bold": true},{"translate":"Show Edited Gamerules","color": "#428cc9","underlined": true,"hoverEvent":{"action":"show_text","contents":[{"translate":"Click to open"}]},"clickEvent":{"action":"run_command","value":"/trigger gamerules set 90011"}}]
execute if score difficulty refresh_gamerules matches 2 run tellraw @s [{"translate": "   ","color": "gray","hoverEvent": {"action": "show_text","value":{"translate":"Click to Open"}},"clickEvent": {"action": "open_url","value": "https://minecraft.wiki/w/Difficulty"}},{"translate":"World Difficulty: "},{"bold":true,"translate":"options.difficulty.normal","color": "#ffcf3d"},{"text": "      "},{"text":"+ ","color": "#428cc9","bold": true},{"translate":"Show Edited Gamerules","color": "#428cc9","underlined": true,"hoverEvent":{"action":"show_text","contents":[{"translate":"Click to open"}]},"clickEvent":{"action":"run_command","value":"/trigger gamerules set 90011"}}]
execute if score difficulty refresh_gamerules matches 3 run tellraw @s [{"translate": "   ","color": "gray","hoverEvent": {"action": "show_text","value":{"translate":"Click to Open"}},"clickEvent": {"action": "open_url","value": "https://minecraft.wiki/w/Difficulty"}},{"translate":"World Difficulty: "},{"bold":true,"translate":"options.difficulty.hard","color": "#f72533"},{"text": "      "},{"text":"+ ","color": "#428cc9","bold": true},{"translate":"View Edited Gamerules","color": "#428cc9","underlined": true,"hoverEvent":{"action":"show_text","contents":[{"translate":"Click to open"}]},"clickEvent":{"action":"run_command","value":"/trigger gamerules set 90011"}}]
...
execute unless score commandBlockOutput refresh_gamerules matches 0 run tellraw @s [{"translate": "","color": "aqua"},{"text":"+ ","bold": true},{"translate":"Command Block Output: "},{"score":{"name": "commandBlockOutput","objective": "refresh_gamerules"},"color":"#c2c2c2" }]
execute if score commandBlockOutput refresh_gamerules matches 0 run tellraw @s [{"translate": "   ","color": "gray"},{"translate":"Command Block Output: "},{"score":{"name": "commandBlockOutput","objective": "refresh_gamerules"},"color":"#c2c2c2" }]
...
tellraw @s [{"translate": "","color": "yellow"},{"translate":"\n"},{"translate":"<-- Return","color":"yellow","underlined":false,"hoverEvent":{"action":"show_text","contents":[{"translate":"Previous Page"}]},"clickEvent":{"action":"run_command","value":"/trigger gamerules set 2"}},{"translate":"    - 1/7 -     ","color": "gray","italic": false},{"translate":"","color": "yellow"},{"translate":"","color": "yellow"},{"translate":"Page 2 -->","color":"yellow","underlined":false,"hoverEvent":{"action":"show_text","contents":[{"translate":"Next Page"}]},"clickEvent":{"action":"run_command","value":"/trigger gamerules set 12"}}]
