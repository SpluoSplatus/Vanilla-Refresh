...
execute if score temp refresh_storage matches 0 run tellraw @s [{"translate":"Applied permanent night vision","color":"gray"}]
execute if score temp refresh_storage matches 1 run tellraw @s [{"translate":"Removed permanent night vision","color":"gray"}]
