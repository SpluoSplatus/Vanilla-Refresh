...
execute store result score temp refresh_storage run data get entity @s NoAI

execute if score temp refresh_storage matches 0 run tag @s add refresh_entity_misc
...
execute if score temp refresh_storage matches 0 run data modify entity @s PersistenceRequired set value 1b


execute if score temp refresh_storage matches 1 run tag @s remove refresh_entity_misc

execute if score temp refresh_storage matches 1 run data modify entity @s NoAI set value 0b
execute if score temp refresh_storage matches 1 run data modify entity @s Silent set value 0b
execute if score temp refresh_storage matches 1 run data modify entity @s Invulnerable set value 0b
execute if score temp refresh_storage matches 1 run data modify entity @s PersistenceRequired set value 0b
