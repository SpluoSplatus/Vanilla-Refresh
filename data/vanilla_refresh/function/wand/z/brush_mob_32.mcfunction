...
$execute as @e[distance=..2,type=$(wand_mob_filter),tag=!refresh_entity_misc] as @e[distance=..16,type=$(wand_mob_filter),type=!#vanilla_refresh:misc_mob_wand_player,tag=!refresh_entity_misc] at @s run function vanilla_refresh:wand/z/brush_mob_poof
