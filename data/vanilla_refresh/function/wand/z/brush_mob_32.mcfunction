...
execute as @e[distance=..2,type=!#vanilla_refresh:misc_brush,tag=!refresh_entity_misc] as @e[distance=..16,type=!#vanilla_refresh:misc_brush,tag=!refresh_entity_misc] at @s run function vanilla_refresh:wand/z/brush_mob_poof
