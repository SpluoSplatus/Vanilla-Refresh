...
$execute as @n[type=$(wand_mob_filter),tag=!refresh_temp_usingwand,distance=..2] at @s unless entity @s[type=#vanilla_refresh:displays] run function vanilla_refresh:wand/z/mob_model_set_data
