...
execute as @s[advancements={vanilla_refresh:wand/brush_mob=true}] anchored eyes positioned ^ ^ ^ run function vanilla_refresh:wand/z/brush_mob
execute as @s[advancements={vanilla_refresh:wand/brush_mob_32=true}] anchored eyes positioned ^ ^ ^ run function vanilla_refresh:wand/z/brush_mob_32
execute as @s[advancements={vanilla_refresh:wand/brush_mob_large=true}] anchored eyes positioned ^ ^ ^ run function vanilla_refresh:wand/z/brush_mob_large
...
execute as @s[advancements={vanilla_refresh:wand/show_64=true}] anchored eyes positioned ^ ^ ^ run function vanilla_refresh:wand/z/show_64
