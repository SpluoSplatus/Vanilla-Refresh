...
execute as @n[type=text_display,tag=refresh_currently_in_editing,distance=..24] unless data entity @s brightness.block run data merge entity @s {brightness:{sky:15,block:0}}
